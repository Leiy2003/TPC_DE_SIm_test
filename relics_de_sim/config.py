...
class DetectorConfig:
    ...
    radius_mm: float = 82.5
    height_mm: float = 156.0
    fiducial_radius_mm: float = 82.5
...
class SimulationConfig:
    ...
    sim_low_limit_pe: int = 30
    sim_up_limit_pe: int = 300
    roi_low_limit_pe: float = 60.0
